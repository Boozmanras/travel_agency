...
<!-- Mirrored from andit.co/projects/html/and-tour/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2023 10:30:59 GMT -->
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<!-- Title -->
<title>Spoonbills tours and travel </title>
<!-- Bootstrap css -->
...
<li><a href="#!"><span>+254794988992</span></a></li>
...
<div class="dropdown-menu language-dropdown-menu">
<a class="dropdown-item" href="#">Ksh</a>
...
<ul class="dropdown-menu">
<li class="nav-item">
<a href="flight-search-result.php" class="nav-link">Flight</a>
</li>
<li class="nav-item">
<a href="flight-booking-submission.php" class="nav-link">Flight Booking</a>
</li>
</ul>
</li>
<li class="nav-item">
